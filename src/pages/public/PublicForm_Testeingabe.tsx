...
const PROXY_BASE = '';
const APP_ID = '6a021c917f18a4cc7a34585a';
...
export default function PublicFormTesteingabe() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Testeingabe — Formular</h1>
        </div>
